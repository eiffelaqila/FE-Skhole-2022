...
export default function RumbelHeaderLayout({
    ...
    return (
        <>
            ...
            <EditMatpelModal isOpen={isOpenEditModal} onOpen={onOpenEditModal} onClose={onCloseEditModal} userToken={userToken} id_matpel={id_matpel} nama_matpel={nama_matpel} kelas={kelas} icon_src={icon_src} />
            <DeleteMatpelModal isOpen={isOpenDeleteModal} onOpen={onOpenDeleteModal} onClose={onCloseDeleteModal} userToken={userToken} id_matpel={id_matpel} />
        </>
    )
}