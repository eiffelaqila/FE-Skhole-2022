...
import { Box, Center, Heading, Image, Flex, VStack } from "@chakra-ui/react";
...
export default function Search() {
    ...
    }, [router, router.query, updateData]);
                    ...
                    <VStack>
                        ...
                        {searchData?.mata_pelajaran.length !== 0 ? (
                            <Flex
                                ...
                                gap={{ base: "2", md: "5" }}
                            >
                                <Heading fontSize={"xl"} color="#FEE56C">
                                    Mata Pelajaran
                                </Heading>
                            ...
                            >
                                ...
                                {searchData?.materi.map((item) => (
                                    <SearchCard
                                        key={item.id_matpel}
                                        id_matpel={item.id_matpel}
                                        nama_matpel={item.nama_materi}
                                        kelas={item.nama_matpel.concat(
                                            " - ",
                                            item.kelas
                                        )}
                                    />
