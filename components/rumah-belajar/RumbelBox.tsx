    ...
    return (
        <>
            <Flex flexDirection={{ base: 'column', md: 'row' }} justifyContent={{base: 'flex-start', md: 'space-between'}} padding="50px 35px 0px 0px">
                <Heading color="white" paddingLeft={{base:"60px", md:"80px" }} fontSize={{base: '42', md: '54'}}>
            ...
            { kelas ?
                <AddMatpelModal isOpen={isOpenAddMatpelModal} onOpen={onOpenAddMatpelModal} onClose={onCloseAddMatpelModal} userToken={userToken} kelas={kelas} />
            :
                <Center h="20vh">
                    <Image src="/static/images/loading.svg" />
                </Center>
