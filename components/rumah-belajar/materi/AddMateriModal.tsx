        ...
        >
            ...
            <ModalBody pb={6}>
                <FormControl>
                    ...
                    <Input placeholder={`Nama Materi`} onChange={(e) => setNewNamaMateri(e.target.value)}/>
                </FormControl>

                <FormControl mt={4}>
                    <FormLabel>Deskripsi</FormLabel>
                    <Input placeholder={`Deskripsi`} onChange={(e) => setNewDeskripsi(e.target.value)}/>
                </FormControl>

                <FormControl mt={4}>
                    <FormLabel>URL Rangkuman</FormLabel>
                    <Input placeholder={`URL Rangkuman`} onChange={(e) => setNewURLRangkuman(e.target.value)}/>
                </FormControl>

                <FormControl mt={4}>
                    <FormLabel>URL Ujian</FormLabel>
                    <Input placeholder={`URL Ujian`} onChange={(e) => setNewURLUjian(e.target.value)}/>
                </FormControl>
                
                <FormControl mt={4}>
                    <FormLabel>URL Solusi</FormLabel>
                    <Input placeholder={`URL Solusi`} onChange={(e) => setNewURLSolusi(e.target.value)}/>
                </FormControl>
            </ModalBody>
